...
import findProduct from '@salesforce/apex/customAddProduct_Quote_class.findProduct';
import saveProducts from '@salesforce/apex/customAddProduct_Quote_class.saveProducts';
import getproductfamily from '@salesforce/apex/customAddProduct_Quote_class.getproductfamily';
import findRecentPrices from '@salesforce/apex/customAddProduct_Quote_class.findRecentPrices';
...
export default class AddProductQuote extends NavigationMixin(LightningElement) {
    cols = COLS;
    ...
    connectedCallback() {
        ...
        // findProduct({ recordId: this.recId, productFamily: [] }).then(result => {
