...
import getAssessmentMaster from '@salesforce/apex/LwcStageGateScoreControllerStage3.getAssessmentMaster';
import getAssessmentAnswer from '@salesforce/apex/LwcStageGateScoreControllerStage3.getAssessmentAnswer';
import getDescisionCriteria from '@salesforce/apex/LwcStageGateScoreControllerStage3.getDescisionCriteria';
import saveData from '@salesforce/apex/LwcStageGateScoreControllerStage3.saveData';
import getDocumentUrl from '@salesforce/apex/LwcStageGateScoreControllerStage3.getDocumentUrl';
import getFiledDisplay from '@salesforce/apex/LwcStageGateScoreControllerStage3.getFiledDisplay';
...
export default class LwcStageGateScoreStageGate3 extends NavigationMixin(LightningElement) {
    @api recordId;
    @track total = 0;
            ...
            saveData({ JS: JSON.stringify(this.assData), descJs: JSON.stringify(this.decisionData), score: this.total, recordId: this.recordId,
             label: this.label,approverLabel:this.selectedValue,openDecisionCriteria:this.openDecisionCriteria,reason:this.rejectedReson }).then(result => {
                if (result.Message && result.Message.startsWith('Success')) {
                    ...
                    this.showToast('Success', `Development Stage Record Updated successfully.`, 'Success');
                    this.handleCancel();
