...
import getAssessmentMaster from '@salesforce/apex/LwcStageGateScoreControllerStage2.getAssessmentMaster';
import getAssessmentAnswer from '@salesforce/apex/LwcStageGateScoreControllerStage2.getAssessmentAnswer';
import getDescisionCriteria from '@salesforce/apex/LwcStageGateScoreControllerStage2.getDescisionCriteria';
import saveData from '@salesforce/apex/LwcStageGateScoreControllerStage2.saveData';
import getDocumentUrl from '@salesforce/apex/LwcStageGateScoreControllerStage2.getDocumentUrl';

import getFiledDisplay from '@salesforce/apex/LwcStageGateScoreControllerStage2.getFiledDisplay';
import getRecordDetail from '@salesforce/apex/LwcStageGateScoreControllerStage2.getRecordDetail';
import deletefile from '@salesforce/apex/LwcStageGateScoreControllerStage2.deletefile';
...
export default class LwcStageGateScoreStageGate2 extends NavigationMixin(LightningElement) {
    @api recordId;
    @track total = 0;
    ...
    fetchAssessmentMaster() {
        getAssessmentMaster({ recordId: this.recordId })
            .then((data) => {
                ...
                console.log('total-->', this.total, this.isValidUser,this.ApprovalStatus);
    ...
    handleSave() {
       let tempCheck = true;
        ...
        if (tempCheck) {
            ...
            ,approverLabel:this.selectedValue,openDecisionCriteria:this.openDecisionCriteria,reason:this.rejectedReson}).then(result => {
                ...
                if (result.Message && result.Message.startsWith('Success')) {
                    ...
                    this.showToast('Success', `Assess Feasibiity Stage Record Updated successfully.`, 'Success');
                    this.handleCancel();
